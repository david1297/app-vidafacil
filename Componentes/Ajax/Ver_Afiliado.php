<?php
	...
	require_once ("../../config/conexion.php");
		...
		$sTable = "AFILIADOS inner join TIPIFICACIONES on TIPIFICACIONES.Numero = AFILIADOS.Tipificacion
							 left join USUARIOS on AFILIADOS.Comercio= USUARIOS.Nit	
							 ";
		$sWhere = "where AFILIADOS.Visible ='S' and Id='$Id' ";
		...
		AFILIADOS.Estado,AFILIADOS.AEstado
		 FROM  $sTable $sWhere";
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<h2 class="mb-0" style="margin-bottom: 0px;margin-top: 0px;">
							...
							<i class="fas fa-angle-down"></i>Gestiones
							</button>
						</h2>
						</div>
						...
						<div class="card-body">
							<button class="btn btn-primary"type="button" onclick="GenerarGestion('<?php echo $Id;?>')">Agregar Gestion</button>
