        ...
        <section>
            <div class="hero-slider">
                    <div class="single-hero-item set-bg">
                        <img src="img/banner/servicios/6.png" alt="">
                    </div>
            </div>
        </section>
    <!-- Hero Section End -->
            ...
            <div class="col-lg-8">
                <div class="blog__details__content">
                    <div class="blog__details__text">
                        <p>.Proveer es prepararse para el futuro, es planificar un entorno de bienestar ante situaciones que inevitablemente habrán de suceder. Hacerlo habla de amor y de responsabilidad para con nuestros seres queridos. Cuando tomamos en cuenta algo tan importante evitamos tomar decisiones en momentos emocionalmente complicados, evitamos gastos imprevistos y protegemos a nuestros seres queridos al tener una solución integral.</p>
                    </div>
