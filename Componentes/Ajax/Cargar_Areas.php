...
<?php
	...
	$Descripcion=$row['Nombre'];
		...
		<tr>
			...
			<input type="text" class="form-control" id="Descripcion_A<?php echo $Numero;?>" name="Descripcion_A<?php echo $Numero;?>"  placeholder="Descripcion" value="<?php echo $Descripcion;?>" onkeypress="UpdateDescAreas(event,<?php echo $Numero;?>)">
			 </td>
