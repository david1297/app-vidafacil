...
<?php include("Menu.php")?>
        <section>
            <div class="hero-slider">
                    ...
                    <img src="img/banner/servicios/12.png" alt="">
                    </div>
            </div>
        </section>
    <!-- Hero Section End -->
            ...
            <div class="col-lg-8">
                <div class="blog__details__content">
                    <div class="blog__details__text">
                        <p>Servicios de reparación o mantenimiento preventivo. Descuento en servicios adicionales durante el año. Descuento en piezas durante el año. Servicio vía telefónica ilimitados.</p>
                    </div>
