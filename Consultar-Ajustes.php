...
<div id="Menus">
			...
			<div class="container-fluid">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<h4><i class='glyphicon glyphicon-search'></i>Ajustes</h4>
	...
	<script type="text/javascript" src="Componentes/JavaScript/Ajustes.js"></script>
	<script>
	function CambioEFiltro(){
		var Filtro =  $("#EFiltro").val();
		$("#loader").fadeIn('slow');
			$.ajax({
				url:'Componentes/Ajax/Filtros_Ajustes.php?Filtro='+Filtro,
